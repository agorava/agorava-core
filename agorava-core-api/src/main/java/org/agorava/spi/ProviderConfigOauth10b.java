...
import static org.agorava.api.extractor.ExtractorType.Type.OAUTH1_USER_ID;
...
import static org.agorava.api.oauth.OAuth.OAuthVersion.OTHER;
 ...
 */
@OAuth(OTHER)
public abstract class ProviderConfigOauth10b extends ProviderConfigOauth {
