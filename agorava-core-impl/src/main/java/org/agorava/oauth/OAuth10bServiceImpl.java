...
import org.agorava.spi.ProviderConfigOauth10b;
...
@Generic
@OAuth(ONE)
public class OAuth10bServiceImpl extends OAuthServiceBase {
    private static Logger LOGGER = Logger.getLogger(OAuth10bServiceImpl.class.getName());


    @InjectWithQualifier
    ProviderConfigOauth10b api;
